    ...
    <Container>
      {favoriteProduct?.length > 0 ? (
        ...
        <div className="mx-auto flex max-w-3xl flex-col gap-3 items-center text-center">
          ...
          <p className="text-lg leading-6 tracking-tight text-gray-500">
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Soluta ut
            commodi ipsam provident numquam, odit cupiditate, incidunt cum
            pariatur excepturi dicta laboriosam error quo dolore libero. Maxime
            ad laborum libero?
          </p>
          <Link
            to={"/product"}
